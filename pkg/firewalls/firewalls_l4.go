...
func EnsureL4FirewallRule(cloud *gce.Cloud, nsName string, params *FirewallParams, sharedRule bool, fwLogger klog.Logger) (bool, error) {
	...
	if existingFw == nil {
		...
		if utils.IsForbiddenError(err) && cloud.OnXPN() {
			...
			return true, newFirewallXPNError(err, gcloudCmd)
		}
		return true, err
	}
...
func ensureFirewall(svc *v1.Service, shared bool, params *FirewallParams, cloud *gce.Cloud, recorder record.EventRecorder, fwLogger klog.Logger) (bool, error) {
	nsName := utils.ServiceKeyFunc(svc.Namespace, svc.Name)
	wasUpdated, err := EnsureL4FirewallRule(cloud, nsName, params, shared, fwLogger)
	if err != nil {
...
func EnsureL4LBFirewallForHc(svc *v1.Service, shared bool, params *FirewallParams, cloud *gce.Cloud, recorder record.EventRecorder, fwLogger klog.Logger) (bool, error) {
...
func EnsureL4LBFirewallForNodes(svc *v1.Service, params *FirewallParams, cloud *gce.Cloud, recorder record.EventRecorder, fwLogger klog.Logger) (bool, error) {
